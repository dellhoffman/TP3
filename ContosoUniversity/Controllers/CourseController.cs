...
namespace ContosoUniversity.Controllers
{
    public class CourseController : Controller
    {
        ...
        public ActionResult Create([Bind(Include = "CourseID, Title, Credits, DepartmentID, PartnerID")]Course course)
        {
            ...
            PopulatePartnerDropDownList(course.PartnerID);
            return View(course);
        }
        ...
        public ActionResult EditPost(int? id)
        {
            ...
            PopulatePartnerDropDownList(courseToUpdate.PartnerID);
        ...
        {
            var partnerQuery = from p in db.Partners
                               orderby p.Name
                               select p;
            List<SelectListItem> partners = new SelectList(partnerQuery, "PartnerID", "Name", selectedPartner).ToList();
            partners.Insert(0, (new SelectListItem { Text = "Selecione...", Value = "" }));
            ViewBag.PartnerID = partners;
